...
# Load Required data file & libraries
...
```{r}
# --- 5. Annotate RUNX1 Mutation Status ---
runx1_tcga   <- unique(mut_tcga$Tumor_Sample_Barcode[mut_tcga$Hugo_Symbol == "RUNX1"])
pheno_tcga$condition   <- ifelse(pheno_tcga$SAMPLE_ID %in% runx1_tcga, "Mutated", "WildType")
runx1_ohsu22 <- unique(mut_ohsu22$Tumor_Sample_Barcode[mut_ohsu22$Hugo_Symbol == "RUNX1"])
pheno_ohsu22$condition <- ifelse(pheno_ohsu22$SAMPLE_ID %in% runx1_ohsu22, "Mutated", "WildType")
...
# --- 6. Filter Expression and Phenotype to Shared Samples ---
...
# --- 8. Convert Expression Data to Numeric Matrices for Analysis ---
...
# --- 9. Harmonize Genes Across All Cohorts ---
...
```
# Log2 Transformation, Batch Correction and Normalization
...
# --- 11. Reorder Columns to Match Phenotype Order ---
...
```{r}
# --- 13. DExMA Meta-Analysis & Visualization ---
...
# 13.3 Create DExMA meta-analysis object
...
# 13.4 Harmonize gene annotation and ensure log2 transformation
objectMA <- allSameID(objectMA, finalID="GeneSymbol", organism="Homo sapiens")
objectMA <- dataLog(objectMA)

# 13.5 Optional: Heterogeneity assessment
heterogeneityTest(objectMA)

# 13.6 Run meta-analysis (Random Effects Model)
...
# 13.7 Filter for significant & biologically relevant genes
sig_genes <- resultsMA[resultsMA$FDR < 0.05 & abs(resultsMA$AveFC) > 1, ]


# 13.8 Save significant genes to CSV
write.csv(sig_genes, file = "DExMA_sig_genes_RUNX1.csv", row.names = TRUE)

# 13.9 Visualize: Heatmap of top significant genes
...
# 3. Barplot for top 15 KEGG pathways by gene count
